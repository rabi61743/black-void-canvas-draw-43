...
// import type { ProcurementPlan, QuarterlyTarget } from "@/types/procurement-plan"; // Use imported types
// import {
//   Tooltip,
//   TooltipContent,
//   TooltipProvider,
...
//         const data = await response.json();
//         // Normalize data to ensure quarterly_targets is an array
//         const normalizedData = Array.isArray(data)
//           ? data.map((plan: ProcurementPlan) => ({
//               ...plan,
//               quarterly_targets: plan.quarterly_targets || [],
...
//           .flat()
//           .join(', ') || 'Failed to create procurement plan';
//         throw new Error(errorMessage);
//       }

//       const createdPlan = await response.json();
//       // Normalize quarterly_targets for the new plan
//       createdPlan.quarterly_targets = createdPlan.quarterly_targets || [];
//       setPlans(prev => [...prev, createdPlan]);
//       toast({
//         title: "Success",
...
//       toast({
//         title: "Error",
//         description: error.message || 'Failed to create procurement plan',
//         variant: "destructive",
//       });
//       throw error;
//     }
