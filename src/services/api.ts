...
// Base API URL - use VITE_API_BASE_URL from environment variables
const API_URL = import.meta.env.VITE_API_BASE_URL || "http://localhost:8000/"; // Fallback for development
...
// // Base API URL - adjust according to your Django server
